...
bt = BulletTrain(environment_id=api_key)
...
if print_result_of_feature_enabled_for_environment.lower() == 'y':
    print(bt.feature_enabled(feature_name))
...
if print_result_of_feature_enabled_for_identity.lower() == 'y':
    print(bt.feature_enabled(feature_name, identity=identifier))
...
if set_trait.lower() == 'y':
    ...
    bt.set_trait(trait_key, trait_value, identifier)
    print('Trait set successfully')
    print('Result from get_trait is %s' % bt.get_trait(trait_key, identifier))
